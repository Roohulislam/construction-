    ...
    <section style={{ backgroundColor: "#faf9f5" }} className="py-2 px-2 sm:px-6 lg:px-8 bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">13-Block H Gulberg-II, Lahore, Pakistan</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-1">Make a call</h3>
                  <p className="text-gray-600">(+92-42) 35711411</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@habibrafiq.com</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <h2 className="text-2xl font-bold text-gray-800 mb-6">PLEASE CONTACT US</h2>
